...
p_load("lmerTest", "lme4", "broom.mixed", "flextable")
...
broom.mixed::tidy(fit1) %>% mutate_if(is.numeric, round, 2) %>% 
  flextable::flextable()
# This quantity above is not giving us the group-specific overall ATT
...
#-----Estimate individual group effects (2000, 2003, 2006) and then pool the results----
#ExD1----
#Using the DID method
#Using the generalized SCM method
